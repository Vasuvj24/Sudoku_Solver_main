  ...
  for(let i=0;i<id("number_container").children.length;i++){
    id("number_container").children[i].addEventListener("click",function(){
      ...
      if(!disableselect){
        ...
        if(this.classList.contains("selected")){//agar kuch bhe selected h to vo this hojayega
...
function starttime(){
  ...
  //timer is more of avariable for time that is made
